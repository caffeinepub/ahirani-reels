...
import type { AdRpmConfig, VideoType } from "../context/AppContext";
...
function AdminDashboard({ onLogout }: { onLogout: () => void }) {
  ...
  const [activeTab, setActiveTab] = useState<"overview" | "users" | "videos">(
    "overview",
  );
  ...
  return (
    <div className="min-h-dvh bg-background">
      ...
      {/* Tabs */}
      <div className="sticky top-[65px] z-10 bg-background border-b border-white/10 flex">
